...
# WARNING: make sure to declare the file "doc/description.md" as a "data file"
#          (see key "data_files").
__DIR__ = os.path.dirname(os.path.abspath(__file__))
long_description_path = os.path.join(__DIR__, 'doc', 'description.md')
...
setuptools.setup(
    ...
    author_email="dbeurive@protonmail.com",
    ...
    entry_points={
        'console_scripts': ['agora = agora.agora:run']
    },
