...
def process_month(csv_input: str,
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.BOXPLOT_VENDOR_TRANSACTION_COUNTS] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.BOXPLOT_VENDOR_TRANSACTION_AVERAGE_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.BOXPLOT_VENDOR_TRANSACTION_MAX_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.BOXPLOT_VENDOR_TRANSACTION_SUM_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.HBAR_VENDOR_TRANSACTION_COUNTS] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.HBAR_VENDOR_TRANSACTION_AVERAGE_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.HBAR_VENDOR_TRANSACTION_MAX_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.HBAR_VENDOR_TRANSACTION_SUM_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.BOXPLOT_SHIP_FROM_TRANSACTION_COUNTS] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.BOXPLOT_SHIP_FROM_TRANSACTION_AVERAGE_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.BOXPLOT_SHIP_FROM_TRANSACTION_MAX_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.BOXPLOT_SHIP_FROM_TRANSACTION_SUM_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.HBAR_SHIP_FROM_TRANSACTION_COUNTS] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.HBAR_SHIP_FROM_TRANSACTION_AVERAGE_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.HBAR_SHIP_FROM_TRANSACTION_MAX_BTC] + ".svg")
    ...
    in_report.add_document_to_set(set_name,
                                  ...
                                  None,
                                  outputs[GraphType.HBAR_SHIP_FROM_TRANSACTION_SUM_BTC] + ".svg")
